 ...
 *
 * Where files-db/tests/php/ proves the EXTENSION obeys the contract, this suite
 ...
 * escapes neither (files-db/docs/usage.md §7). So a document containing both,
...
function quanta_env(): array
{
    ...
    // afterwards (files-db/docs/usage.md §3).
    if (qdb_ext()) {
